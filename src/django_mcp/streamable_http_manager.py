...
from collections.abc import Awaitable, AsyncIterator, MutableMapping
...
class StreamableHTTPSessionManager:
    ...
    def __init__(
        self,
        app: Proxy[typing.Any, typing.Any],
        ...
        self.security_settings: TransportSecuritySettings | None = security_settings
