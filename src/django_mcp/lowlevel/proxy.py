...
class Proxy(Generic[LifespanResultT, RequestT]):
    def __init__(
        ...
        self.notification_options: NotificationOptions = NotificationOptions()
    ...
    def get_prompt(self):
        def decorator(
            ...
            print("Registering handler for GetPromptRequest")
    ...
    def set_logging_level(self):
        def decorator(func: Callable[[types.LoggingLevel], Awaitable[None]]):
            print("Registering handler for SetLevelRequest")
    ...
    def progress_notification(self):
        def decorator(
            ...
            print("Registering handler for ProgressNotification")
    ...
    def completion(self):
        ...
        def decorator(
            ...
            print("Registering handler for CompleteRequest")
    ...
    async def _handle_notification(self, notify: Any):
        if handler := self.notification_handlers.get(type(notify)):  # type: ignore
            ...
            try:
                ...
                print("Uncaught exception in notification handler")
