"""StreamableHTTP Session Proxy Manager for MCP servers."""
...
class StreamableHTTPSessionProxyManager:
    """
    ...
    async def _handle_stateless_request(
        ...
        Args:
            ...
            send: ASGI send function
        """
        print("Stateless mode: Creating new transport for this request")
    ...
    async def _handle_stateful_request(
        ...
        if request_mcp_session_id is None:
            ...
            async with self._session_creation_lock:
                ...
                # print(f"scope, receive, send: {scope, receive, send}")
